...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
              <a class="navbar-brand" href="#">Pengelolaan Staff TU</a>
                ...
                @if (Auth::check())
                    @if (Auth::user()->role == "staff")
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Data User</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{ route('userStaff.home') }}">Data Staff Tata Usaha</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{ route('dataSurat.home') }}">Data Surat</a></li>
                            </ul>
                        </li>
                        @endif
